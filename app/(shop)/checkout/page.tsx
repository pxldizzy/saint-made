      ...
      <div className="mt-[60px] grid gap-[60px] lg:grid-cols-[1fr_420px]">
        <form onSubmit={submit} className="flex flex-col gap-[20px]">
          <label>
            ...
            <input name="name" required minLength={2} className={`${field} mt-[10px]`} placeholder="Иван Иванов" />
          </label>
          <label>
            <span className="text-body font-bold uppercase">Телефон</span>
            <input name="phone" required type="tel" className={`${field} mt-[10px]`} placeholder="+7 900 000-00-00" />
          </label>
          <label>
            <span className="text-body font-bold uppercase">E-mail</span>
            <input name="email" type="email" className={`${field} mt-[10px]`} placeholder="you@example.com" />
          </label>
          <label>
            <span className="text-body font-bold uppercase">Адрес доставки</span>
            <input name="address" required minLength={5} className={`${field} mt-[10px]`} placeholder="Город, улица, дом, квартира" />
          </label>
          <label>
